...
fs = sqldf(sprintf("SELECT * FROM FIA_subset WHERE ELEV > 8200"))
...
pairs(PIAL_CLASS4~ABLA_CLASS4+PIEN_CLASS4+ABLA_CLASS3+PIEN_CLASS3+ABLA_CLASS2+PIEN_CLASS2+ABLA_CLASS1+PIEN_CLASS1, data = fs, main = "Scatterplot Matrix (Above 10000' elevation)")
