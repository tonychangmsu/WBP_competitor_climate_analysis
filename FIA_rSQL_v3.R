...
#Version: 3.0
#Author: Tony Chang
#Date: 11/16/2015, Modified Date 03/07/2016, Modified Data 07/01/2016
#Abstract:  
#			Version 1
...
#
#			Version 3
#			07/01/2016 changes: Additional column added to consider aggregate of BA_M2HA for all competing conifer species for PIAL 
#
##############################################################################################################################
...
out$BA_M2HA_ALL_OTHERS  =  (out$ALL_TREES_BA_M2HA - out$PIAL_BA_M2HA - out$ABLA_BA_M2HA - out$PIEN_BA_M2HA - out$PSME_BA_M2HA - out$PICO_BA_M2HA)
out$BA_M2HA_ALL_CONI  =  (out$ABLA_BA_M2HA + out$PIEN_BA_M2HA + out$PSME_BA_M2HA + out$PICO_BA_M2HA) #additional column added @tchang 07.01.2016

out$PIAL_BA_M2HA_123 = out$PIAL_CLASS1_BA_M2HA + out$PIAL_CLASS2_BA_M2HA + out$PIAL_CLASS3_BA_M2HA
out$PIAL_BA_M2HA_124 = out$PIAL_CLASS1_BA_M2HA + out$PIAL_CLASS2_BA_M2HA + out$PIAL_CLASS4_BA_M2HA
out$PIAL_BA_M2HA_134 = out$PIAL_CLASS1_BA_M2HA + out$PIAL_CLASS3_BA_M2HA + out$PIAL_CLASS4_BA_M2HA
out$PIAL_BA_M2HA_234 = out$PIAL_CLASS2_BA_M2HA + out$PIAL_CLASS3_BA_M2HA + out$PIAL_CLASS4_BA_M2HA
